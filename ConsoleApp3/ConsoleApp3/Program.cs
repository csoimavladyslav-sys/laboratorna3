...
class Program
{
    ...
    // -----------------------------------------------------
    // 2. Розрахунок покупки — код з попередньої роботи
    // -----------------------------------------------------
    static void CalculateOrder()
    {
        ...
        double discount = rnd.Next(5, 16); // 5–15%
    ...
    // -----------------------------------------------------
    // 3. Інформація про заклад (заглушка)
    // -----------------------------------------------------
    static void Info()
    {
        Console.Clear();
    ...
    // -----------------------------------------------------
    // Допоміжна функція читання числа з перевіркою
    // -----------------------------------------------------
